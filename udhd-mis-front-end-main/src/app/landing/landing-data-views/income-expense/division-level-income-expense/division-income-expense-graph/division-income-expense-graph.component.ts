...
@Component({
  selector: 'app-division-income-expense-graph',
  templateUrl: './division-income-expense-graph.component.html',
  styleUrls: ['./division-income-expense-graph.component.css']
})
export class DivisionIncomeExpenseGraphComponent implements OnInit {
  ...
  // barChartLabels: Label[] = ['income'+ this.dataToDisplay.currentPeriod, 'income' + this.dataToDisplay.previousPeriod, '', 'expense', 'expense']
