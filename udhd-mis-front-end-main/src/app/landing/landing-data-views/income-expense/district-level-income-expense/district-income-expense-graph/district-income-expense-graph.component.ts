...
@Component({
  selector: 'app-district-income-expense-graph',
  templateUrl: './district-income-expense-graph.component.html',
  styleUrls: ['./district-income-expense-graph.component.css']
})
export class DistrictIncomeExpenseGraphComponent implements OnInit {
