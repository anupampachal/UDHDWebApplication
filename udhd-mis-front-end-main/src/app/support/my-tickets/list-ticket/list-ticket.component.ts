...
export class ListTicketComponent implements OnInit {
  ...
  paginationTableData$: Observable<MatTableWithPagination<TicketDTO>> =
  of();
...
setTableData(data: GenericResponseObject<TicketDTO>) {
  const matTableData = new MatTableWithPagination<TicketDTO>();
  matTableData.cols = [
    'name',
    'active',
  ];
