...
@Component({
  selector: 'app-data-views-dash-base',
  templateUrl: './data-views-base.component.html' ,
  styleUrls: ['./data-views-base.component.css']
})
export class DataViewsDashboardBaseComponent implements OnInit {
