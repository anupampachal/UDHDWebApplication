...
@Component({
  selector: 'app-list-fixed-asset',
  templateUrl: './list-fixed-asset.component.html',
  styleUrls: ['./list-fixed-asset.component.css']
})
export class ListFixedAssetComponent implements OnInit {
  ...
  updatedExportToExcel() {
    ...
    this.dmt.exportAsExcelFile(excelJsonData, 'Fixed Asset', wscols)
  }
