...
@Component({
  selector: 'app-list-cag-pac',
  templateUrl: './list-cag-pac.component.html',
  styleUrls: ['./list-cag-pac.component.css']
})
export class ListCagPacComponent implements OnInit {
