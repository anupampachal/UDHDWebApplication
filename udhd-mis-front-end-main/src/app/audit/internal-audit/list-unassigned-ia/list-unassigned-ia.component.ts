...
@Component({
  selector: 'app-list-unassigned-ia',
  templateUrl: './list-unassigned-ia.component.html',
  styleUrls: ['./list-unassigned-ia.component.css']
})
export class ListUnassignedIaComponent implements OnInit {
