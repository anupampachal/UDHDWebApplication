...
@Component({
  selector: 'app-edit-part-bh',
  templateUrl: './edit-part-bh.component.html',
  styleUrls: ['./edit-part-bh.component.css']
})
export class EditPartBHComponent implements OnInit {
