...
@Component({
  selector: 'app-view-cap-exp-receipt',
  templateUrl: './view-cap-exp-receipt.component.html',
  styleUrls: ['./view-cap-exp-receipt.component.css']
})
export class ViewCapExpReceiptComponent implements OnInit {
  ...
  expendId: number = 0;
  detailsId = 1
  administrativeExpensesId = 1
  operationAndMaintenanceId = 1
  loanRepaymentId = 1
  otherExpenditureId = 1
  developmentWorksId = 1
  otherCapitalExpenditureId = 1
  ...
  headingFix(item: string) {
    if(item == "Loan Repayments(Prinicipal Amount)" ) {
      return false
    }
    if(item == "Revenue Expenditure" ) {
      return false
    }
    if(item == "Capital Expenditure" ) {
      return false
    }
    if(item == "Total Expenditure (1+2)" ) {
      return false
    }
  ...
  createRevenueCapitalExpenditureForm(): FormGroup {
    return this.fb.group({
      ...
      'receiptAmount': new FormControl({ value: null, disabled: true }, [Validators.required]),
      'administrativeExpenseAmount': new FormControl({ value: null, disabled: true }, [Validators.required]),
      'oMAmount': new FormControl({ value: null, disabled: true }, [Validators.required]),
      'loanRepaymentAmount': new FormControl({ value: null, disabled: true }, [Validators.required]),
      'othersAmount': new FormControl({ value: null, disabled: true }, [Validators.required]),
      'capitalAmount': new FormControl({ value: null, disabled: true }, [Validators.required]),
      'schemeAmount': new FormControl({ value: null, disabled: true }, [Validators.required]),
      'loanRepaymentPrincipalAmount': new FormControl({ value: null, disabled: true },),
      'othersCapitalExpenditureAmount': new FormControl({ value: null, disabled: true }, [Validators.required]),
    });
