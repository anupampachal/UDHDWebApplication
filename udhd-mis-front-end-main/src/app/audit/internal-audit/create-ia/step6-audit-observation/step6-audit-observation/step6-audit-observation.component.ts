...
@Component({
  selector: 'app-step6-audit-observation',
  templateUrl: './step6-audit-observation.component.html',
  styleUrls: ['./step6-audit-observation.component.css']
})
export class Step6AuditObservationComponent implements OnInit {
  ...
  // 'g)   Physical verification of Inventory/Stores.', 'h)   Advances, their adjustment and recovery. ', 'i)   Any other matter as may be prescribed in due course. '
]
  partBijk: string[] = [ ]
