...
@Component({
  selector: 'app-list-unassigned-agir-audit',
  templateUrl: './list-unassigned-agir-audit.component.html',
  styleUrls: ['./list-unassigned-agir-audit.component.css'],
})
export class ListUnassginedAgirAuditComponent implements OnInit {
