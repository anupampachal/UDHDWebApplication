...
@Component({
  selector: 'app-list-asssigned-to-me-agir-audit',
  templateUrl: './list-asssigned-to-me-agir-audit.component.html',
  styleUrls: ['./list-asssigned-to-me-agir-audit.component.css'],
})
export class ListAssignedToMeAGIRAudit implements OnInit {
  ...
  assignedToMeAGIRAudit(){
    console.log("assigned to me audits")
  }
