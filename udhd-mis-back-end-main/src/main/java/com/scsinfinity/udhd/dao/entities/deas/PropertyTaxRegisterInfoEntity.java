...
@NoArgsConstructor
@Table(name = "DEAS_PROPERTY_TAX_REGISTER")
public class PropertyTaxRegisterInfoEntity extends BaseIdEntity implements Serializable {
	/**
	* 
	*/
	private static final long serialVersionUID = -7553390840224608691L;
	@ManyToOne
	...
	public PropertyTaxRegisterDTO getDto() {
		// @formatter:off
		FinYearDateDTO dateRange;
		try {
			dateRange = getFinDates(yearStartDate, yearEndDate);
			return PropertyTaxRegisterDTO.builder()
					.id(id)
