...
@NoArgsConstructor
@Table(name = "DEAS_FIXED_ASSETS_REGISTER")
public class FixedAssetsRegisterEntity extends BaseIdEntity implements Serializable {
	/**
	* 
	*/
	private static final long serialVersionUID = -3727899841338174941L;
	@ManyToOne
	...
	public FixedAssetsRegisterDTO getDto() {
		// @formatter:off
		FinYearDateDTO dateRange;
		try {
			dateRange = getFinDates(yearStartDate, yearEndDate);
			return FixedAssetsRegisterDTO.builder()
					.id(id)
